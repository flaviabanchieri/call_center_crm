                      ...
                      children: [
                                ...
                                child: FutureBuilder<List<UsuarioRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      ...
                                      hintText: 'Atendente (obrigatório)',
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
                                            .secondaryText,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'Checkout code (opcional)',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelLarge
                                  .override(
                                    fontFamily: 'Manrope',
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.tagValue == null) {
                                      _model.validation = false;
                                    }
                                    if (_model.atendenteValue == null) {
                                      _model.validation = false;
                                    }
                                    if (_model.produtoValue == null) {
                                      _model.validation = false;
                                    }
                                    shouldSetState = true;
